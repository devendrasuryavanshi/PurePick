...
export default function HeroButton({ onOpen }) {
    return (
        <button onClick={onOpen} className="relative inline-flex h-12 overflow-hidden rounded-full p-[1px] focus:outline-none focus:ring-offset-2 focus:ring-offset-black">
