            ...
            <div className="container mx-auto px-4">
                <div className="flex flex-col gap-4 justify-between items-center">
                    ...
                    <div className="flex gap-4 text-gray-400">
                        <Link href="https://www.linkedin.com/in/devendrasuryavanshi/">
                            <Linkedin className="w-6 h-6 hover:text-gray-300" />
                        </Link>
                        <Link href="https://www.instagram.com/devendrasooryavanshee/">
                            <Instagram className="w-6 h-6 hover:text-gray-300" />
                        </Link>
                        <Link href="https://x.com/Devendra_Dood">
                            <Twitter className="w-6 h-6 hover:text-gray-300" />
                        </Link>
                        <Link href="https://github.com/devendrasuryavanshi">
